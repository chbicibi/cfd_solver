...
def red(*args, **kwargs):
    return remove_empty_dirs(*args, **kwargs)
...
def chunked_fill(iterable, n, fillvalue=None):
...
def _import(module, name=None, ver=None, table=None):
    if name is None:
        name = module
